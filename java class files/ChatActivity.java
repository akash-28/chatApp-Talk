...
public class ChatActivity extends AppCompatActivity {
    ...
    public FirebaseRecyclerAdapter<Show_Chat_Activity_Data_Items, Show_Chat_ViewHolder> mFirebaseAdapter; //this viewholder is inner class
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        myRef.keepSynced(true);//for offline support
